...
| TC-UI-02 | FR-06 | Log in with incorrect password | Registered user exists | Displays error message, does not log in | Automated |
| TC-UI-03 | FR-07 | Log out from an active session | User is logged in | Redirects to login page, session ends | Automated |
